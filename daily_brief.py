...
CONFIG = {
    ...
    "email": {
        "smtp_login":  os.environ["BREVO_SMTP_LOGIN"],   # e.g. a54321001@smtp-brevo.com
        "sender":      os.environ["EMAIL_SENDER"],        # your real email address
        "password":    os.environ["BREVO_SMTP_KEY"],      # SMTP key from Brevo dashboard
...
def send_email(html, cfg):
    ...
    with smtplib.SMTP(cfg["smtp_host"], cfg["smtp_port"]) as server:
        ...
        server.ehlo()
        server.login(cfg["smtp_login"], cfg["password"])
